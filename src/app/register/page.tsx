      ...
      <Card className="w-full max-w-md bg-white/70 dark:bg-zinc-900/50 backdrop-blur-md border border-zinc-200/85 dark:border-zinc-800/85 rounded-3xl shadow-xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-xs text-zinc-500">
            Join CollegeCompass to bookmark and compare your favorite institutions.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label htmlFor="name" className="text-xs font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">
                Full Name
              </label>
